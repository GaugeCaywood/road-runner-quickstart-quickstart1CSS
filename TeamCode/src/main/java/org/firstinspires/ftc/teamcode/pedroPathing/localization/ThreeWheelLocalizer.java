...
public class ThreeWheelLocalizer extends Localizer {
    ...
    public static double TURN_TICKS_TO_RADIANS = 0.002955;//8192 * 1.37795 * 2 * Math.PI * 0.5;
    ...
    public ThreeWheelLocalizer(HardwareMap map, Pose setStartPose) {
        ...
        strafeEncoderPose = new Pose(-9, 4.5, Math.toRadians(90));
        ...
        strafeEncoder = new Encoder(hardwareMap.get(DcMotorEx.class, "fl"));
