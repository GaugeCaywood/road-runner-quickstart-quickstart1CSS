...
//
//
//@Autonomous(name="Human Player Side Red RR 2+1", group="Auton")
//public class HPRedRR21 extends LinearOpMode {
//    //////////////////VISION//////////////////////
...
//
//    enum Stage {firststage, preLoadTravel,scorepreload, drivetostack, placePixel, liftUp, park, liftDown, driveToMiddle, end}
...
//                .build();
//        TrajectorySequence DriveToLiftUpPos = drive.trajectorySequenceBuilder(DriveToStackLeft.end())
...
//                        servoClose = true;
//                    }
//                    if(!drive.isBusy() && servoClose){
//                      drive.followTrajectorySequenceAsync(DriveToLiftUpPos);
//                    }
//                    stage = Stage.liftUp;
//                    break;
//
