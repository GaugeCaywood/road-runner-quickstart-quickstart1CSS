...
//
//@Autonomous(name="blueHumanPlayerSide", group="Auton")
//public class blueHPSide extends LinearOpMode {
...
//    private static final double SERVO_POWER = 0.30;
//    //VARIABLES FOR PURPLE PIXEL SCORE ON LINe
//    private static final double MOTOR_POWER = 0.50;
//    private static final long PIXEL_PLACEMENT_FORWARD = 700;  // Time in milliseconds
//    private static final long PIXEL_PLACEMENT_LEFT = 500;
//    private static final long PIXEL_PLACEMENT_RIGHT = 300;
...
//    private static final long PIXEL_SCORE_LEFT = 1000;
//    private static final double RIGHT_PIXEL_SCORE_SPEED = 0.25;
//    private static final long PIXEL_SCORE_RIGHT = 350;
...
//
//    }
//        private void moveForwardAndPlacePixelright() {
//
//            robot.wrist.setPosition(.7);
//            robot.forward(MOTOR_POWER);
//            telemetry.addData("Currently Recorded Position", colourMassDetectionProcessor.getRecordedPropPosition());
...
//
//            robot.stop();
//            while (opModeIsActive() && timer.milliseconds() < PIXEL_PLACEMENT_RIGHT) {
//
//                idle();
//
//
...
//                telemetry.addData("detected line is ", "left");
//                telemetry.update();
//                moveForwardAndPlacePixeleft(1);
//                //turnMoveForwardPlacePixel(1);
//                break;
//            case UNFOUND: // we can also just add the unfound case here to do fallthrough intstead of the overriding method above, whatever you prefer!
//                telemetry.addData("detected line is ", "Unfound");
//                telemetry.update();
//                moveForwardAndPlacePixelright();
//                //turnMoveForwardPlacePixel(2);
//                break;
//            case MIDDLE:
//                telemetry.addData("detected line is ", "Middle");
//                telemetry.update();
//                moveForwardAndPlacePixelMiddle(2);
//                //turnMoveForwardPlacePixel(2);
//                // code to do if we saw the prop on the middle
//                break;
//            case RIGHT:
//                telemetry.addData("detected line is ", "Right");
//                telemetry.update();
//                moveForwardAndPlacePixelright();
