...
@Config
public class ColourMassDetectionProcessorRed implements VisionProcessor, CameraStreamSource {
     ...
     */
    public ColourMassDetectionProcessorRed(@NonNull Scalar lower, @NonNull Scalar upper, DoubleSupplier minArea, DoubleSupplier left, DoubleSupplier right) {
