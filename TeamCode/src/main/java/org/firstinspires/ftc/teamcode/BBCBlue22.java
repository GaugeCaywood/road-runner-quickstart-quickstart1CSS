...
@Config
@Autonomous(name="Background side Blue 2+2 ", group="Auton")
public class BBCBlue22 extends LinearOpMode {
    //////////////////VISION//////////////////////
...
public boolean backUp = false;
    ...
    public void runOpMode() {
        ...
        TrajectorySequence DriveToCollectFirstR = drive.trajectorySequenceBuilder(DriveToBackBoardR.end())
                ...
                .splineToLinearHeading(new Pose2d(-57,37, Math.toRadians(180)),Math.toRadians(-90))
                .build();
...
//                    put your vision processor in here
                ...
                case park:
                    if(!drive.isBusy()) {
                        drive.followTrajectorySequenceAsync(DriveToPark);
